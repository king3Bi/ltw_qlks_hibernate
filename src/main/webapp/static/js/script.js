...
function totalPrice(id_loai_phong){
    ...
    fetch(uri, {
        ...
        console.info(data)
        document.querySelector('#total-price').innerHTML = Intl.NumberFormat('vi-VN').format(data);
    })
}
/*
function roomSearchCustomer(idRoomType) {
    ...
    const uri = "/nhom12-ltw-hibernate-qlks/api/find-rooms-by-room-type?" +
